...
class ChatGPTActionSchemaTests(unittest.TestCase):
    def test_openapi_exposes_only_expected_actions(self):
        ...
        expected_paths = {
            ...
            "/integrations/chatgpt/investment-portfolio",
            "/integrations/chatgpt/investment-operations",
            "/integrations/chatgpt/investment-assets",
            "/integrations/chatgpt/investment-valuation-records",
            "/integrations/chatgpt/saving-goal-allocations",
        }
